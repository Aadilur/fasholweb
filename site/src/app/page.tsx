...
export default async function HomePage() {
 ...
 {t(lang, "Building a safe, sustainable food supply chain", "নিরাপদ, টেকসই সাপ্লাই চেইন গড়ে তুলছি")}
 </Reveal>
 <Reveal
 as="p"
 delay={0.16}
 ...
 >
 {t(lang, "Better pay for the farmers who grow it, and ", "যারা ফলান সেই কৃষকদের জন্য ন্যায্য দাম, আর ")}
 <span className="text-[var(--color-deep-green)] font-medium">{t(lang, "safe, traceable produce", "নিরাপদ, সম্পূর্ণ ট্রেসেবল পণ্য")}</span>{" "}
 ...
 {[
 { v: "60,000+", vBn: "60,000+", l: "Registered farmers", lBn: "নিবন্ধিত কৃষক" },
 { v: "7,000+", vBn: "7,000+", l: "Buyers", lBn: "বায়ার" },
 { v: "15,000+ MT", vBn: "15,000+ মেট্রিক টন", l: "Food loss prevented", lBn: "রোধ করা খাদ্য অপচয়" },
 { v: "4+ Countries", vBn: "4+ দেশ", l: "cross-border supply chain solution", lBn: "আন্তঃসীমান্ত সাপ্লাই চেইন সলিউশন" },
 ].map((s) => (
 ...
 <div className="text-[17px] tablet:text-[22px] leading-none t-tabular !text-[var(--color-deep-green)]" style={{ fontWeight: 500 }}>{t(lang, s.v, s.vBn)}</div>
 <div className="t-caption !text-[var(--color-ink-subtle)] mt-1 tablet:mt-1.5">{t(lang, s.l, s.lBn)}</div>
 </div>
 ))}
 </div>
 </div>
 ...
 <p className="t-body" style={{ fontWeight: 500 }}>{t(lang, "As featured in", "যাদের প্রতিবেদনে")}</p>
 <LogoMarquee
 colored
 height={44}
 centerAlt="Forbes"
 ...
 {t(lang, "Safe food, direct from the farmer's field to the buyer's door.", "নিরাপদ খাদ্য, সরাসরি কৃষকের মাঠ থেকে বায়ারের দরজায়।")}
 </Reveal>
 ...
 {t(lang, "Five nodes, 18 to 24 hours from the farmer to the buyer's door.", "পাঁচটি ধাপ, কৃষক থেকে বায়ারের দরজা পর্যন্ত মাত্র 18 থেকে 24 ঘণ্টা।")}
 </h3>
 <div className="mt-6">
 <Image
 ...
 {[
 { n: "01", t: "FARMER", tBn: "কৃষক", s: "Direct procurement", sBn: "সরাসরি প্রোকিউরমেন্ট", stat: "60,000+ growers", statBn: "60,000+ চাষি", d: "Field agents register the farmer on the Jogaan app and lock the price at weighing.", dBn: "ফিল্ড এজেন্ট যোগান অ্যাপে কৃষককে নিবন্ধন করেন এবং ওজনের সময়েই দাম নিশ্চিত করেন।" },
 { n: "02", t: "DISTRICT HUB", tBn: "জেলা হাব", s: "Grade and cold-store", sBn: "গ্রেডিং ও কোল্ড-স্টোরেজ", stat: "40+ hubs", statBn: "40+ হাব", d: "Four-tier quality grading, applied at hub intake.", dBn: "হাবে পণ্য গ্রহণের সময়েই চার স্তরের কোয়ালিটি গ্রেডিং।" },
 { n: "03", t: "PLATFORM", tBn: "প্ল্যাটফর্ম", s: "Match and settle", sBn: "মিলিয়ে দেওয়া ও সেটেলমেন্ট", stat: "24h payout", statBn: "24 ঘণ্টায় পরিশোধ", d: "Mobile money settlement to the farmer.", dBn: "কৃষকের কাছে মোবাইল মানিতে সেটেলমেন্ট।" },
 { n: "04", t: "LAST MILE", tBn: "লাস্ট মাইল", s: "Refrigerated dispatch", sBn: "রেফ্রিজারেটেড ডিসপ্যাচ", stat: "1,050+ MT/month", statBn: "মাসে 1,050+ মেট্রিক টন", d: "Refrigerated trucks on Fashol's own delivery routes.", dBn: "ফসলের নিজস্ব ডেলিভারি রুটে রেফ্রিজারেটেড ট্রাক।" },
 { n: "05", t: "BUYER'S DOOR", tBn: "বায়ারের দরজা", s: "Order to delivery", sBn: "অর্ডার থেকে ডেলিভারি", stat: "7,000+ buyers", statBn: "7,000+ বায়ার", d: "From a Dhaka MSME to an exporter shipping into Singapore, Dubai, or Bangkok.", dBn: "ঢাকার একটি ছোট ব্যবসা থেকে শুরু করে সিঙ্গাপুর, দুবাই বা ব্যাংককে পাঠানো এক্সপোর্টার পর্যন্ত।" },
 ].map((c) => (
 <div key={c.n} className="p-5 tablet:p-6 bg-[var(--color-paper)] flex flex-col gap-2.5">
 <h4 className="t-h5 tracking-[-0.02em]" style={{ fontWeight: 500 }}>{t(lang, c.t, c.tBn)}</h4>
 <p className="t-caption">{t(lang, c.s, c.sBn)}</p>
 <p className="t-body-sm text-[var(--color-ink-subtle)] mt-1">{t(lang, c.stat, c.statBn)}</p>
 ...
 {t(lang, "Wash, grading & processing centres - coming to every region.", "ওয়াশ, গ্রেডিং ও প্রসেসিং সেন্টার - আসছে প্রতিটি অঞ্চলে।")}
 </Reveal>
 <Reveal delay={0.08} className="desktop:col-span-6 t-body-lg !text-[rgba(255,251,234,0.75)]">
 <p>
 {t(lang, "Fashol is building agri-product wash, grading, and processing centres across Bangladesh - one safety standard, close to where food grows. Better returns, less waste, safer food.", "ফসল সারা বাংলাদেশজুড়ে কৃষিপণ্যের ওয়াশ, গ্রেডিং ও প্রসেসিং সেন্টার গড়ে তুলছে - একটাই নিরাপত্তা মান, যেখানে খাদ্য ফলে তার কাছেই। বেশি লাভ, কম অপচয়, আরও নিরাপদ খাদ্য।")}
 </p>
 <p className="mt-5 !text-[var(--color-lime)]" style={{ fontWeight: 500 }}>
 {t(lang, "Rolling out district by district.", "জেলায় জেলায় ছড়িয়ে পড়ছে।")}
 </p>
 </Reveal>
 </div>
 </Section>
 ...
 {t(lang, "Four things a farmer on Fashol has, that a farmer off it usually does not.", "ফসলে থাকা একজন কৃষক যে চারটি সুবিধা পান, বাইরে থাকা কৃষক সাধারণত যা পান না।")}
 </h2>
 </Reveal>
 ...
 bodyBn: "200-এর বেশি বাজারের সরাসরি তথ্যের ভিত্তিতে ফসলের দাম নির্ধারিত হয়, তাই কৃষক ঘর থেকে বেরোনোর আগেই দাম জেনে নেন।",
 },
 {
 ...
 bodyBn: "ওজনের 24 ঘণ্টার মধ্যেই টাকা পৌঁছে যায় কৃষকের মোবাইল ওয়ালেটে - কোনো ইনভয়েস নেই, মধ্যস্বত্বভোগীর কাটাকাটি নেই।",
 },
 {
 ...
 bodyBn: "যোগানের মার্কেটপ্লেসে মেলে কোয়ালিটি-যাচাই করা বীজ, কীটনাশক, খাবার আর যন্ত্রপাতি - ফসল নেটওয়ার্কের জন্য দর কষে যে দাম ঠিক করে সেই দামে।",
 },
 {
 ...
 bodyBn: "2026 সাল থেকে ফসল পার্টনার ব্যাংকের সঙ্গে ফাইন্যান্সিং ও চলতি মূলধন দেবে, যার ভিত্তি হবে যোগানে জমা হওয়া বিক্রির ইতিহাস।",
 },
 ].map((c) => (
 ...
 <Reveal as="h2" className="t-h2 max-w-3xl">
 {t(lang, "Four kinds of buyers. One platform, built around each.", "চার ধরনের বায়ার। একটাই প্ল্যাটফর্ম, প্রত্যেকের কথা ভেবে গড়া।")}
 </Reveal>
 ...
 bodyBn: "হাইপারফার্মে আগের রাতে অর্ডার করুন, সকালের সার্ভিসের আগেই তাজা পণ্য পৌঁছে যাবে আপনার রান্নাঘরের দরজায়। ভোর 4টায় আর পাইকারি বাজারে ছোটা লাগবে না।",
 ...
 bodyBn: "হাইপারফার্মে রিয়েল-টাইম স্টক আর প্রতিদিনের দাম, সঙ্গে আপনার ডিস্ট্রিবিউশন সেন্টারে কোল্ড-চেইন সরবরাহ। কৃষক থেকে চূড়ান্ত অর্ডার পর্যন্ত পুরো পথ ট্রেসেবল।",
 ...
 bodyBn: "হাব থেকে সরাসরি পাইকারি দাম, কোয়ালিটি গ্রেডিং হয় পণ্য গ্রহণের সময়েই - শহরের পাইকারি বাজারে নয়। সব কার্যক্রম চলে ফসল প্ল্যাটফর্মে।",
 standout: "The volume of aratdar, with transparency aratdar never had",
 standoutBn: "আড়তদারের মতো পরিমাণ, তবে আড়তদার যে ট্রান্সপারেন্সি কখনও দিতে পারেনি তা নিয়ে",
 },
 {
 num: "04",
 title: "Exporters",
 ...
 bodyBn: "হাবে গ্রহণের সময়েই গ্রেড এ বাছাই, বিমানবন্দর পর্যন্ত নিবেদিত কোল্ড-চেইন রুট, আর এক্সপোর্টের কাগজপত্র শুরু থেকে শেষ পর্যন্ত আমরাই সামলাই। পণ্য সবচেয়ে টাটকা অবস্থাতেই পৌঁছে যায় গন্তব্যের বাজারে।",
 ...
 {t(lang, "We source in Bangladesh. We deliver across the region.", "সংগ্রহ করি বাংলাদেশে। পৌঁছে দিই গোটা অঞ্চলজুড়ে।")}
 </h2>
 ...
 {t(lang, "Four offices run on a single operating system. Every order moves on the same stock, pricing, and settlement engine.", "চারটি অফিস চলে একটাই অপারেটিং সিস্টেমে। প্রতিটি অর্ডার এক অভিন্ন স্টক, প্রাইসিং আর সেটেলমেন্ট ইঞ্জিনে পরিচালিত হয়।")}
 </p>
 ...
 <dt className="tracking-[0.05em] uppercase !text-[var(--color-paper)]" style={{ fontWeight: 500 }}>{t(lang, "Dhaka", "ঢাকা")}</dt>
 <dd className="!text-[rgba(255,251,234,0.55)]">{t(lang, "Headquarters and operations", "সদর দপ্তর ও পরিচালন")}</dd>
 <dt className="tracking-[0.05em] uppercase !text-[var(--color-paper)]" style={{ fontWeight: 500 }}>{t(lang, "Singapore", "সিঙ্গাপুর")}</dt>
 <dd className="!text-[rgba(255,251,234,0.55)]">{t(lang, "Regional trade desk", "আঞ্চলিক বাণিজ্য ডেস্ক")}</dd>
 <dt className="tracking-[0.05em] uppercase !text-[var(--color-paper)]" style={{ fontWeight: 500 }}>{t(lang, "Dubai", "দুবাই")}</dt>
 <dd className="!text-[rgba(255,251,234,0.55)]">{t(lang, "Middle East gateway", "মধ্যপ্রাচ্যের প্রবেশদ্বার")}</dd>
 <dt className="tracking-[0.05em] uppercase !text-[var(--color-paper)]" style={{ fontWeight: 500 }}>{t(lang, "Bangkok", "ব্যাংকক")}</dt>
 <dd className="!text-[rgba(255,251,234,0.55)]">{t(lang, "Southeast Asia desk", "দক্ষিণ-পূর্ব এশিয়া ডেস্ক")}</dd>
 </dl>
 </div>
 </div>
 ...
 {t(lang, "Four corridors out of Dhaka.", "ঢাকা থেকে চারটি করিডোর।")}
 </h3>
 <p className="mt-5 text-[14px] tablet:text-[15px] leading-[1.55] !text-[rgba(255,251,234,0.72)]">
 {t(lang, "Air and sea routes to Singapore, the Gulf, and Southeast Asia - grading-verified and cold-chain handled from farm gate through customs.", "সিঙ্গাপুর, উপসাগরীয় অঞ্চল আর দক্ষিণ-পূর্ব এশিয়ায় আকাশ ও সমুদ্রপথ - খামারের গেট থেকে কাস্টমস পর্যন্ত গ্রেডিং-যাচাই আর কোল্ড-চেইন সামলানো।")}
 </p>
 </div>
 ...
 <div className="bg-[var(--color-ink)] rounded-[32px] p-8 tablet:p-10 pt-[190px] tablet:pt-[230px] desktop:pt-[260px] flex flex-col">
 <h3 className="text-[24px] tablet:text-[28px] desktop:text-[32px] leading-[1.1] tracking-[-0.015em] !text-[var(--color-paper)]" style={{ fontWeight: 500 }}>
 {t(lang, "The eagle-eye view of your supply.", "আপনার সাপ্লাই চেইনের ঈগল-চোখের দৃশ্য।")}
 </h3>
 <p className="mt-5 text-[14px] tablet:text-[15px] leading-[1.55] !text-[rgba(255,251,234,0.72)]">
 {t(lang, "Every kilogram is traced, graded, and QC-checked before it leaves our hub. Buyers follow it live on one dashboard - status, grades, cold-chain, settlement.", "প্রতিটি কেজি হাব ছাড়ার আগেই ট্রেস করা হয়, গ্রেড করা হয় আর কিউসি-যাচাই হয়। বায়াররা একটাই ড্যাশবোর্ডে সরাসরি সব দেখেন - স্ট্যাটাস, গ্রেড, কোল্ড-চেইন, সেটেলমেন্ট।")}
 </p>
 </div>
 </div>
 </div>
 ...
 {t(lang, "The network, in the words of the people on it.", "নেটওয়ার্ক, যারা এর অংশ তাদের নিজেদের কথায়।")}
 </h2>
 </Reveal>
 ...
 {t(lang, "The buyers on the platform. The investors behind it.", "প্ল্যাটফর্মে থাকা বায়াররা। পেছনে থাকা বিনিয়োগকারীরা।")}
 </Reveal>
 ...
 {t(lang, "The chain is still being built. Join as a farmer, a buyer, or a colleague.", "চেইন এখনও গড়ে উঠছে। যুক্ত হন কৃষক, বায়ার কিংবা সহকর্মী হিসেবে।")}
 </Reveal>

 <StaggerChildren className="grid tablet:grid-cols-3 gap-6 mt-14" stagger={0.1}>
 {[
 { n: "01", t: "Farmer onboarding", tBn: "কৃষক নিবন্ধন", b: "WhatsApp a field agent. Bring your last season's records, if available.", bBn: "হোয়াটসঅ্যাপে একজন ফিল্ড এজেন্টকে বার্তা দিন। থাকলে গত মৌসুমের হিসাব সঙ্গে আনুন।", cta: "Farmer onboarding", ctaBn: "কৃষক নিবন্ধন", href: "https://wa.me/+8801810187230?text=Hello%21%20I%E2%80%99d%20like%20to%20register%20as%20a%20farmer%20with%20Fashol." },
 { n: "02", t: "Buyer account", tBn: "বায়ার অ্যাকাউন্ট", b: "MSMEs, quick-commerce, exporters, wholesalers. Ten-minute setup.", bBn: "ছোট-মাঝারি ব্যবসা, কুইক-কমার্স, এক্সপোর্টার, পাইকার। দশ মিনিটে সেটআপ।", cta: "Buyer account", ctaBn: "বায়ার অ্যাকাউন্ট", href: "https://wa.me/+8801810187230?text=Hello%21%20I%E2%80%99d%20like%20to%20buy%20produce%20through%20Fashol." },
 { n: "03", t: "Work with us", tBn: "আমাদের সঙ্গে কাজ করুন", b: "Open roles in engineering, logistics, field operations, and data.", bBn: "ইঞ্জিনিয়ারিং, লজিস্টিকস, ফিল্ড অপারেশন আর ডেটায় খোলা পদ।", cta: "Work with us", ctaBn: "আমাদের সঙ্গে কাজ করুন", href: "/career" },
 ].map((c) => (
 ...
 <p className="t-body !text-[rgba(255,255,255,0.7)]">{t(lang, c.b, c.bBn)}</p>
 <div className="mt-auto pt-4">
 <Button variant="on-dark" href={c.href} external={c.href.startsWith("http")}>{t(lang, c.cta, c.ctaBn)}</Button>
 </div>
 </StaggerItem>
 ))}
 </StaggerChildren>
